  ...
  return (
    <div className="space-y-3" suppressHydrationWarning={true}>
      ...
      <div className="relative group" suppressHydrationWarning={true}>
        <div className="absolute inset-0 bg-gradient-to-r from-amber-400 to-green-400 rounded-xl blur opacity-25 group-hover:opacity-40 transition-opacity duration-300" suppressHydrationWarning={true}></div>
...
const PlatformFeature: React.FC<{
  ...
  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl backdrop-blur-sm border border-amber-200/50 dark:border-amber-700/30" suppressHydrationWarning={true}>
    <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-r from-amber-500 to-green-500 rounded-lg flex items-center justify-center" suppressHydrationWarning={true}>
...
export default function RegisterPageClient({ dictionary }: { dictionary: any }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(data.message || t.form.successAlert);

      setTimeout(() => {
        router.push(`/${lang}/verify-email?email=${encodeURIComponent(data.email)}`);
      }, 2000);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-green-50 to-yellow-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 p-4" suppressHydrationWarning={true}>
      
      <div className="fixed inset-0 overflow-hidden pointer-events-none" suppressHydrationWarning={true}>
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-amber-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob" suppressHydrationWarning={true}></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-green-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000" suppressHydrationWarning={true}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-4000" suppressHydrationWarning={true}></div>
      </div>

      <div className="relative z-10 w-full max-w-7xl mx-auto" suppressHydrationWarning={true}>
        <div className="grid lg:grid-cols-2 gap-12 items-center" suppressHydrationWarning={true}>
          ...
          <div className="hidden lg:block" suppressHydrationWarning={true}>
            ...
            <div className="space-y-4 mb-8" suppressHydrationWarning={true}>
            ...
            <div className="bg-white/60 dark:bg-gray-800/60 rounded-xl p-6 backdrop-blur-sm border border-amber-200/50 dark:border-amber-700/30" suppressHydrationWarning={true}>
              <div className="text-center" suppressHydrationWarning={true}>
                <div className="flex justify-center mb-3" suppressHydrationWarning={true}>{[1,2,3,4,5].map((star) => <div key={star} className="text-yellow-400 text-lg">★</div>)}</div>
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0" suppressHydrationWarning={true}>
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-amber-200/50 dark:border-amber-700/30" suppressHydrationWarning={true}>
              <div className="lg:hidden text-center mb-8" suppressHydrationWarning={true}>
